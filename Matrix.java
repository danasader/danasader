...
public class Matrix {
    ...
    private static final String error = "Illegal matrix dimensions.";
    private final int M; // number of rows
    private final int N; // number of columns
    private final int[][] data; // M x N array
    ...
    // method to test if the Matrices are equal to each other A == B
